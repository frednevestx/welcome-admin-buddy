...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LUUD — Você conversa. A LUUD organiza." },
      { name: "description", content: "A secretária inteligente da sua empresa, que organiza finanças e tarefas pelo WhatsApp." },
      { property: "og:title", content: "LUUD — Você conversa. A LUUD organiza." },
      { property: "og:description", content: "A secretária inteligente da sua empresa, que organiza finanças e tarefas pelo WhatsApp." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "LUUD — Você conversa. A LUUD organiza." },
      { name: "twitter:description", content: "A secretária inteligente da sua empresa, que organiza finanças e tarefas pelo WhatsApp." },
